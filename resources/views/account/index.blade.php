                                ...
                                <div class="flex-column">
                                    <div class="row d-flex align-items-center">
                                        ...
                                        @if($user->status == 'disable')
                                            <span
                                                class="badge rounded-pill bg-warning shadow-none text-dark ml-2 px-2 h-75">未激活</span>
                                        @endif
                                    </div>
                                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 d-flex">
                                        <button type="submit"
                                                ...
                                                type="button" data-toggle="modal" data-user-email="{{ $user->email }}"
                                                data-user-name="{{ $user->name }}" data-target="#deleteAccountModal"
                                                onclick="readUserDataToDelete(this)">
                ...
                <div class="modal-content">
                                                ...
                                                <div class="col-4 d-flex align-items-center justify-content-end">
                                                    <label class="switch m-0">
                                                        <input type="checkbox" class="form-control"
                                                               id="addAccount{{ $permission->elementId }}PermissionControl"
                                                               name="{{ $permission->columnName }}"
                                                               @if($permission->checkedByDefault)
                                                               checked
                                                            @endif
                                                        >
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary btn-md" data-dismiss="modal"
                                onclick="showAddAccountSuccessAlert()">添加
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('/account/' . $user->id) }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group md-form">
                                <input type="text" class="form-control @error("name") is-invalid @enderror"
                                       id="editAccountFullNameControl" name="name">
                            ...
                            <div class="form-group md-form">
                                <input type="password" class="form-control @error("password") is-invalid @enderror"
                                       id="editAccountPasswordControl" name="password">
                            ...
                            <div class="form-group md-form">
                                <input type="password"
                                       ...
                                       id="editAccountConfirmPasswordControl" name="password_confirmation">
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                ...
                                                <div class="col-4 d-flex align-items-center justify-content-end">
                                                    <label class="switch m-0">
                                                        <input type="checkbox" class="form-control"
                                                               id="editAccount{{ $permission->elementId }}PermissionControl"
                                                               name="permissions[{{ $permission->columnName }}]">
                                                        <span class="slider round"></span>
                                                    </label>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-danger btn-md shadow-none"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger btn-md" data-dismiss="modal"
                                onclick="showDeleteAccountSuccessAlert()">删除
                        </button>
                    </div>
                </div>
            </div>
